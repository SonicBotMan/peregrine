...
REF_MD5=$(md5_of "$FTP_ROOT/big.bin")
echo "ref md5: $REF_MD5"

(
    cd "$QA_DIR/ftp" && nohup python3 ftpd.py >ftpd.log 2>&1 &
    echo $! >ftpd.pid
)
sleep 2
